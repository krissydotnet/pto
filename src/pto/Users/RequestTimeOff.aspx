...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-8">
            ...
            <asp:Panel ID="pnlExistingPTO" runat="server">
            <section id="ptoExistingRequests">
                <div class="form-horizontal">
                    <h2>Existing PTO Requests</h2>
                    <asp:Label ID="lblMessage" runat="server" Text="Label"></asp:Label>
                    <asp:GridView ID="gvExistingRequests" datakeynames="id" onrowcommand="gvExistingRequests_RowCommand" AutoGenerateColumns="false" CssClass="table table-hover table-striped"  runat="server">
                        <Columns>
